...
import 'package:clean_stock/presentacion/pantallas/inventario_principal/inventario_principal.dart';
import 'package:clean_stock/presentacion/pantallas/ventas/registro_ventas.dart';
import 'package:clean_stock/presentacion/pantallas/ventas/nueva_venta.dart';
import 'package:clean_stock/presentacion/pantallas/alertas/alertas.dart';
import 'package:clean_stock/presentacion/pantallas/proveedores/proveedores.dart';
import 'package:clean_stock/presentacion/pantallas/configuracion/configuracion.dart';
...
class _CleanStockHomeScreenState extends State<CleanStockHomeScreen> {
  ...
  void _onCardPressed(BuildContext context, DashboardCardData card) {
    ...
    } else if (card.id == 'registro_venta') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => NuevaVentaScreen()),
      );
    } else if (card.id == 'ventas') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => RegistroVentasScreen()),
      );
    } else if (card.id == 'proveedores') {
      // CONECTADO: Abre la pantalla de proveedores directo
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const CleanStockSuppliersScreen()),
      );
    } else {
      // Aviso temporal exclusivo para el módulo de Ventas generales
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('El módulo de ${card.title} aún está vacío.'), 
